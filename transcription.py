def get_transcription(image_url: str) -> str:
  return '''
          Hec est finalis concordia facta in Curia domini Regis apud Westmonasterium in Octabis sancti Iohannis Baptiste Anno regnorum henrici
        ...
        concordia idem Robertus dedit predicto Thome Centum marcas argenti 
        '''
